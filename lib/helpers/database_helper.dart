...
class DatabaseHelper {
  ...
  Future _onCreate(Database db, int version) async {
    ...
    await db.execute(
        'CREATE TABLE products (id INTEGER PRIMARY KEY, users_id INTEGER KEY, name TEXT NOT NULL, description TEXT NOT NULL, price INTEGER NOT NULL, purchase_month INTEGER NOT NULL)');
  }
}
